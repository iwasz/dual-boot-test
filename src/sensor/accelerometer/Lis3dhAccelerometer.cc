...
#include "Lis3dhAccelerometer.h"
#include "Lis3dhConstants.h"

/*****************************************************************************/

Lis3dh *Lis3dh::instance;

/*****************************************************************************/

Lis3dh::Lis3dh (ILis3dhBsp &bsp, Lis3dhInit const &initStruct) : bsp (bsp)
{
        if (instance) {
                Error_Handler ();
        }
...
int8_t Lis3dh::getTemperature () const
{
        uint8_t tmp = 0;
...
void Lis3dh::interruptConfig (Lis3dhInterruptConfig const &LIS3DSH_IntConfigStruct)
{
...
void Lis3dh::clickITConfig ()
{
        uint8_t ctrl = 0x00;
        Lis3dhInterruptConfig lis3dshInterruptStruct;
...
void Lis3dh::setDataRate (uint8_t DataRateValue)
{
        uint8_t tmpreg;
...
void Lis3dh::setFullScale (uint8_t FS_value)
{
        uint8_t tmpreg;
...
IAccelerometer::AData Lis3dh::getAData () const
{
        int8_t buffer[6];
        uint8_t crtl;
